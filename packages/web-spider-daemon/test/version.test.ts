/**
 * Regression/parity coverage for the vehicle-server migration: VERSION must
 ...
 * @danypops/vehicle-server's readPackageVersion.
 */
import { describe, expect, it } from "bun:test";
import { readFileSync } from "node:fs";
import { VERSION } from "../src/version.ts";

describe("VERSION (via @danypops/vehicle-server's readPackageVersion)", () => {
